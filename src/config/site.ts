...
export const siteConfig = {
  ...
  description:
    "Press any text into premium textured paper. A free online debossed & letterpress text generator — live preview, presets, paper tones, and high-resolution PNG export. Works beautifully with Urdu, Arabic, Hindi, English, and more.",
  /**
