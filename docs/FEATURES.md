...
- [x] Seven fonts: Noto Nastaliq Urdu (default), Gulzar, Noto Naskh Arabic, Playfair Display, Noto Serif Devanagari (Google Fonts), plus Jameel Noori Nastaleeq and its Kasheeda variant (self-hosted from `public/fonts/`); loaded and awaited before first canvas paint
